...
class TestAnonymizeEndpoint:
    ...
    @pytest.mark.integration
    @pytest.mark.api
    def test_anonymize_endpoint_with_valid_payload(
        self, api_client, sample_api_payload
    ):
    ...
    def test_anonymize_endpoint_masks_phone(self, api_client):
        ...
        data = response.json()
        assert (
            "<PHONE>" in data["text_anonymized"]
            or "<EMAIL>" not in data["text_anonymized"]
        )
    ...
    @pytest.mark.integration
    @pytest.mark.api
    def test_anonymize_endpoint_returns_compliance_flag(
        self, api_client, sample_api_payload
    ):
...
class TestScoreEndpoint:
    ...
    @pytest.mark.integration
    @pytest.mark.api
    def test_score_endpoint_returns_valid_score_range(
        self, api_client, sample_api_payload
    ):
...
class TestRequestValidation:
    ...
    def test_payload_with_extra_fields(self, api_client):
        ...
        payload = {"text": "Hello world", "extra_field": "extra_value"}
...
class TestConcurrency:
    ...
    def test_multiple_concurrent_requests(self, api_client):
        ...
        def make_request():
            try:
                response = api_client.post("/score", json={"text": "test message"})
...
class TestResponseFormat:
    ...
    @pytest.mark.integration
    @pytest.mark.api
    def test_score_response_contains_required_fields(
        self, api_client, sample_api_payload
    ):
    ...
    @pytest.mark.integration
    @pytest.mark.api
    def test_anonymize_response_contains_required_fields(
        self, api_client, sample_api_payload
    ):
