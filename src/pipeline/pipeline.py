...
if __name__ == "__main__":
    ...
    print(f"  gcloud ai pipelines runs submit --region=us-central1 --pipeline-root=gs://digital-social-score/pipeline-root --display-name='Digital Score Pipeline' --yaml-pipeline-spec={output_file}")
